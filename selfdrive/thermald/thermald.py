...
DAYS_NO_CONNECTIVITY_MAX = 9999  # do not allow to engage after 9999 days without internet
DAYS_NO_CONNECTIVITY_PROMPT = 9999  # send an offroad prompt after 9999 days with no internet
